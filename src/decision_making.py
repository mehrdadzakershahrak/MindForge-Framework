...
def main():
    ...
    split_context = execute_component('split', user_input, framework, instructions, lm_service)
    ...
    # Final drafting step
    final_output = execute_component('drafting', analysis_context, framework, instructions, lm_service)
